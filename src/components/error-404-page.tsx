    ...
    <div className="min-h-screen w-full relative overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 w-full h-full -z-10">
        <svg
          ...
          className="w-full h-full relative bottom-12 text-slate-950 dark:text-slate-200"
        >
      ...
      <div className="z-10 text-center -translate-y-20">
        <h1 className="text-8xl font-bold text-slate-950 dark:text-slate-200 mb-4">
          404
        </h1>
        <p className="text-slate-950 dark:text-slate-200/80 text-xl mb-8 max-w-[600px] w-[90%] mx-auto">
